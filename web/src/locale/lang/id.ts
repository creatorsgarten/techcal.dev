...
export const id: Record<LocaleKey, string> = {
  ...
  howToAdd_step2: 'Lalu undang',
  howToAdd_step3: 'Beres!!!!',
  howToAdd_disclaimer:
    'Jangan mengundang untuk acara-acara tertutup (berbayar) atau acara yang tidak berkaitan dengan IT',

  howToSub: 'Bagaimana cara memberi tahu suatu acara?',
  howToSub_step1: 'Tambahkan file ical ke kalender Anda',
